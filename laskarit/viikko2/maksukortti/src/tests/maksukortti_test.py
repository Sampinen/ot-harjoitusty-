...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_voit_ostaa_edullisen_lounaan_kun_rahaa_on_tasan_sen_verran(self):
    ...
    def test_voit_ostaa_maukkaan_lounaan_kun_rahaa_on_tasan_sen_verran(self):
    ...
    def negatiivisen_summan_lataaminen_ei_vie_saldoa_negatiivisesksi(self):
